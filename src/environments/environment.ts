...
export const environment = {
  ...
  storageConfig: {
    basePath: 'gs://gl-shoppingcart.appspot.com',
    prefixPath: 'https://firebasestorage.googleapis.com/v0/b/gl-shoppingcart.appspot.com/o/',
    sufixPath: '?alt=media',
    imagesDirectory: '/Epic#4-ProductList',
  },
};
