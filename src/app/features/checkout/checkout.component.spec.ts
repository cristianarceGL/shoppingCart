...
import { OrdertState } from '../order/state/order.reducer';
...
describe('AdminCheckoutComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [CheckoutComponent, TestCmpWrapper],
  ...
  @Component({
    ...
    template: `
      <sc-checkout></sc-checkout>
    `,
  })
  class TestCmpWrapper {
    @ViewChild(CheckoutComponent, { static: true })
    public adminCheckoutComponent: CheckoutComponent;
  }
});
